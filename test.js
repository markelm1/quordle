...
var Fa = Qe((We) => {
  ...
  const ds =
    ...
    cs = ["gypsy", "gipsy", "mammy", "agora", "slave", "hussy"],
    ce = new Set(cs),
    Y =
    ...
    Oe = (e, s) => {
      const t = s.split(""),
        l = e.split(""),
        i = new Array(X).fill("none"),
        n = {};
      for (let o = 0; o < X; o++) n[l[o]] = 0;
      for (let o = 0; o < X; o++)
        t[o] === l[o] &&
      ...
      try {
        ...
        if (a && (o === "free" || a === s)) {
          ...
          (c = {
            ...
            current: "",
            states: pe(y, f),
            answersCorrect: [0, 1, 2, 3].map((C) => y.indexOf(f[C])),
            history: m,
            currentStreak: g,
            maxStreak: b,
          }),
  ...
  const $e = He(),
          ...
          t(
            H((r) => {
              if (
                ...
                (Le.has(r[a].current) || Ee.has(r[a].current)) &&
                !l(a)
              ) {
                const d = r[a].current;
    ...
    De = (e) =>
      (() => {
        ...
        return M(() => E(s, "height", (e.height ? e.height : 16) + "px")), s;
      })(),
    Rs = (e) =>
      (() => {
    ...
    Ws = () => Ms.cloneNode(!0),
    Us = () => As.cloneNode(!0),
    Qs = p('<button type="button"></button>'),
    Ks = p(
              ...
              (() => {
                ...
                return () =>
                  d()
                    ...
                    : (() => {
                        const m = Ys.cloneNode(!0);
                        return m.firstChild, u(m, () => hs(n(), i()), null), m;
                      })();
              })(),
              null
            ),
...
`;
        ...
        if (
          ...
          for (let v = 0; v <= o; v++) {
            ...
            for (y = 0; y < X; y++)
              (b.fillStyle = he(w == null ? void 0 : w[y])),
                le(b, y * (a + r), f * (a + r), a, a, d);
            for (w = s.states[1][v], y = 6; y < X + 6; y++)
            ...
            for (let w = 0; w < 2; w++) {
              ...
              if (
                ...
                (k = b.measureText(j)),
                  ...
                  b.fillText(j, x, f * (a + r) + a - (a - z) / 2, a);
              }
            }
            if (e === "free") {
          ...
          for (let v = 0; v <= c; v++) {
            ...
            for (y = 0; y < X; y++)
              (b.fillStyle = he(w == null ? void 0 : w[y])),
                le(b, y * (a + r), f * (a + r), a, a, d);
            for (w = s.states[3][v], y = 6; y < X + 6; y++)
              (b.fillStyle = he(w == null ? void 0 : w[y - 6])),
                le(b, y * (a + r), f * (a + r), a, a, d);
            f++;
          }
          ...
          if (!q) return;
          const B = `quordle-${e === "daily" ? "daily" : "practice"}-${
              s.seed
            }.png`,
            N = new File([q], B, { type: "image/png" });
          t === "image"
            ? navigator
                .share({ files: [N], text: i })
                .catch((v) => console.error(v))
            : t === "image_save" && Ve.saveAs(N, B);
        }
      }),
    Js = p('<button type="button"></button>'),
    Zs = p(
    ...
    ta = p('<div class="flex items-center justify-center mt-2"></div>'),
    ke = (e) =>
      (() => {
        const s = Js.cloneNode(!0);
        return (
                      ...
                      h(ke, {
                        onClick: () => {
                          ...
                          if (A) {
                            ...
                            R && R.removeAllRanges(), A.blur();
                          }
                          alert("Copied results to clipboard!");
                        },
                        get children() {
                          const A = ra.cloneNode(!0),
                            R = A.firstChild;
                          return u(A, h(Fs, {}), R), A;
                        },
                      })
            ...
            h(Xe, {
              ...
              get children() {
                ...
                return (
                  ...
                  u(q, h(Us, {}), B),
                  u(B, () => (e.mode === "daily" ? "Daily" : "Practice"), N),
                  (v.$$click = () => {
                    $(s.vibration), i(!1);
                  }),
                  u(w, h(Ds, {}), O),
  ...
  oe(["click"]);
  const ca = p(
      '<button class="quordle-key bg-slate-300 dark:bg-zinc-600 pb-[calc(10%-0.25rem)]"><div class="quordle-box-content"> </div></button>'
    ),
    ma = p('<div class="w-full flex-col pb-1"></div>'),
    ha = p('<div class="flex w-full justify-center"></div>'),
    ga = (e) => {
      const [s, t] = Q(),
  ...
  const va = p(
    ...
    _a = p('<div class="text-4xl mt-8 text-center">Loss Distribution</div>'),
    $a = p('<div class="text-lg mb-4 text-center">(# words missed)</div>'),
    ja = p('<div class="text-lg"></div>'),
    Ca = [...Array(S - (V - 1)).keys()].map((e) => e + (V - 1)),
    Sa = [...Array(V).keys()].map((e) => e + S).reverse(),
    qa = (e) => {
      const [s, t] = Q(),
        [l, i] = Z(!1),
        n = _(() => Math.max(...s[e.mode].history.slice(V - 1, S), 1)),
        o = _(() => Math.max(...s[e.mode].history.slice(S), 1)),
        c = _(() =>
          s[e.mode].history.slice(V - 1, S).reduce((y, f) => y + f, 0)
        ),
        a = _(() => s[e.mode].history.slice(S).reduce((y, f) => y + f, 0)),
        r = _(() => c() + a()),
        d = _(() =>
          s[e.mode].answersCorrect.reduce((y, f) => (y += f >= 0 ? 1 : 0), 0)
        ),
        m = _(() => Math.max(...s[e.mode].answersCorrect)),
        g = _(() => t.isGameComplete(e.mode) && d() === V),
        b = _(() => t.isGameComplete(e.mode) && d() < V);
      return (() => {
        const y = va.cloneNode(!0),
          f = y.firstChild,
          C = f.firstChild,
          k = f.nextSibling,
          z = k.firstChild,
                  ...
                  M(
                    (T) => {
                      const J = {
                        ...
                        U = (s[e.mode].history[F] / n()) * 100 + "%";
                      return (
                        (T._v$ = P(W, J, T._v$)),
                        U !== T._v$2 &&
                          W.style.setProperty("width", (T._v$2 = U)),
                        T
                      );
                    },
                    { _v$: void 0, _v$2: void 0 }
                ...
                F() && [
                  (() => {
                    const D = xa.cloneNode(!0),
                      I = D.firstChild;
                    I.firstChild;
                    const W = I.nextSibling,
                      T = W.firstChild;
                    return u(I, c, null), u(W, a, T), D;
                  })(),
                  (() => {
                    const D = za.cloneNode(!0),
                      I = D.firstChild,
                      W = I.nextSibling;
                    return (
                      (D.$$click = () => {
                      ...
                      M(
                        (T) => {
                          ...
                          return (
                            J !== T._v$3 &&
                              I.style.setProperty("width", (T._v$3 = J)),
                            U !== T._v$4 &&
                              W.style.setProperty("width", (T._v$4 = U)),
                            T
                          );
                        },
                  ...
                  (() => {
                    ...
                    return (
                      u(D, () =>
                        Sa.map((I) =>
                          (() => {
                            const W = Ae.cloneNode(!0),
                              T = W.firstChild,
                              J = T.nextSibling;
                            return (
                              u(T, V - (I - S)),
                              u(J, () => s[e.mode].history[I]),
                              M(
                                (U) => {
                                  const Ue = {
                                    ...
                                    je =
                                      (s[e.mode].history[I] / o()) * 100 + "%";
                                  return (
                                    (U._v$5 = P(J, Ue, U._v$5)),
                                    je !== U._v$6 &&
                                      J.style.setProperty(
                                        "width",
                                        (U._v$6 = je)
  ...
  const Ba = p(
    ...
    Ra = p('<div class="flex flex-col flex-auto p-1"></div>'),
        ...
        return (
          ...
          u(
            ...
            h(ua, {
              ...
              onOpenTutorial: () => {
                $(s.vibration),
                  L("event", "tutorial", { mode: e.mode }),
                  i({ overlay: "tutorial" });
              },
              onOpenStatistics: () => {
                $(s.vibration),
                  L("event", "statistics", { mode: e.mode }),
                  i({ overlay: "statistics" });
              },
              onOpenSettings: () => {
                $(s.vibration),
                  L("event", "settings", { mode: e.mode }),
                  i({ overlay: "settings" });
              },
            }),
            b
          ...
          M(
            (k) => {
              ...
              return (
                ...
                q !== k._v$4 &&
                  y.classList.toggle("overflow-hidden", (k._v$4 = q)),
                B !== k._v$5 &&
                  y.classList.toggle("overflow-auto", (k._v$5 = B)),
                N !== k._v$6 && y.style.setProperty("font-size", (k._v$6 = N)),
                v !== k._v$7 && C.style.setProperty("font-size", (k._v$7 = v)),
                k
              );
            },
            {
              ...
              get children() {
                return [
                  h(be, {
                    path: "/",
                    get element() {
                      return h(Be, { mode: "daily" });
                    },
                  }),
                  h(be, {
                    path: "/practice",
                    get element() {
                      return h(Be, { mode: "free" });
                    },
                  }),
                  h(be, {
                    path: "/*all",
...
export default Fa();
//# sourceMappingURL=index.d0ad3358.js.map
